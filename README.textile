...
<pre>
$ ruby app/endpoints/sleepy_streaming.rb -sv -p 9002 # an example endpoint that sleeps a given amount of time before responding.
...
Here I'll make 30 simultaneous requests against son_of_a_batch, **each of them** making 30 concurrent requests against our sleepy_streaming server:
